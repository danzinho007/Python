...
print('\nO valor', n7, 'é um número ? ', n7.isnumeric())
...
print('O valor', n7, 'é uma letra ?', n7.isalpha())
...
print('O valor', n7, 'tem formato ASCII ?', n7.isascii())
...
print('O valor', n7, 'é um dígito ?', n7.isdigit())
# Retorna True se todos os caracteres da string forem dígitos e houver pelo menos um caractere

print('O valor', n7, 'apresenta 4 caracteres em maiúscula e 1 em minúscula ?', n7.islower())
...
print('O valor', n7, 'é uma string com títulos em maiúsculas e tem pelos menos 1 caractere ?', n7.istitle())
